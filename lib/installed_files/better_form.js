...
function validateField() {
  ...
  $.ajax({data:'authenticity_token=' + getAuthenticityToken() + '&' + field_model_name + '[' + field_attribute_name + ']' + '=' + this.value + '&field_id=' + this.id, dataType:'script', type:'post', url: ajax_url, async: false});
}
